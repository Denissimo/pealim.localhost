 ...
 */
final class Version20240812184056 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE pealim_vocabulary (id INT NOT NULL, parent_id INT DEFAULT NULL, slug VARCHAR(64) NOT NULL, word VARCHAR(255) NOT NULL, transcription VARCHAR(255) NOT NULL, russian VARCHAR(255) NOT NULL, root VARCHAR(255) DEFAULT NULL, speech_part VARCHAR(32) NOT NULL, form VARCHAR(16) NOT NULL, is_masculine BOOLEAN DEFAULT NULL, is_plural BOOLEAN DEFAULT NULL, time VARCHAR(16) DEFAULT NULL, person INT DEFAULT NULL, PRIMARY KEY(id))');
